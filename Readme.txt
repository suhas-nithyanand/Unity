...
- I had also used postman to test the web service, but thought it convenient to present the test cases as a bash script.

- All the test cases have explanation is the form of comments above them.
